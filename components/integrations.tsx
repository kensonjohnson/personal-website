...
export default function Integrations() {
  return (
    <section className="relative">
      ...
      <div
        className="absolute bottom-0 left-1/2 hidden h-8 w-0.5 -translate-x-1/2 bg-slate-800 md:block"
        aria-hidden="true"
      />
        ...
        <div className="border-t border-slate-800 py-12 md:py-20">
          ...
          <div className="relative flex flex-col items-center p-16">
            ...
            <div className="relative flex h-32 w-32 items-center justify-center">
              {/* Halo effect */}
              <svg
                className="pointer-events-none absolute inset-0 left-1/2 top-1/2 h-auto max-w-[200%] -translate-x-1/2 -translate-y-1/2 transform"
                width="800"
                height="800"
                viewBox="0 0 800 800"
                xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="relative mx-auto mt-10 grid max-w-xs grid-cols-2 gap-6 sm:max-w-md sm:grid-cols-3 md:mt-20 md:max-w-6xl md:grid-cols-6">
            {/* Top vertical line */}
            <div
              className="absolute -top-16 left-1/2 -mt-2 hidden h-8 w-0.5 -translate-x-1/2 bg-slate-800 md:block"
              aria-hidden="true"
            />
            <div
            ...
            >
              {/* Inner lines */}
              <div
                className="absolute inset-0 -top-10 left-1/2 hidden h-6 w-[calc(100%+24px)] -translate-x-1/2 md:block"
                aria-hidden="true"
              >
                <div className="absolute left-1/2 h-full w-0.5 -translate-x-1/2 bg-slate-800" />
