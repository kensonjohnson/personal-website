...
export default function SideNavigation() {
  ...
  return (
    <div className="no-scrollbar sticky top-0 h-screen w-16 shrink-0 overflow-y-auto border-r border-slate-200 dark:border-slate-800 md:w-24">
          ...
          <nav className="w-full">
            <ul className="space-y-4">
              <li className="py-2">
                <Link
                  href="/"
                  className={`relative flex h-6 w-full items-center justify-center after:absolute after:bottom-0 after:right-0 after:top-0 after:w-0.5 ${
                    pathname !== "/about" &&
                    pathname !== "/subscribe" &&
                    pathname !== "/projects" &&
                    pathname !== "/resume"
