          ...
          <div className="flex items-start">
            ...
            <div className="space-y-1 pl-20">
              ...
              <div className="text-sm text-slate-500 dark:text-slate-400">
                ...
                for detail, and speed. James doesn't just execute and deliver
                incredible codes but works with you to challenge the product or
                flow at hand to create the best possible solution. ”
              </div>
            </div>
          </div>
        </li>
          ...
          <div className="flex items-start">
            ...
            <div className="space-y-1 pl-20">
              ...
              <div className="text-sm text-slate-500 dark:text-slate-400">
                ...
                evaluate and translate ideas into high-fidelity codes, but he's
                also well-versed in UX strategy. While working together, James
                handled our external partnership with Design Agencies, and
                delivered weekly progress reports with fresh ideas. ”
              </div>
            </div>
          </div>
        </li>
